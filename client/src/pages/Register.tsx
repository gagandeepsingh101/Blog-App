...
const Register = () => {
  ...
  return (
    // Registration form
    <div className='h-screen w-screen bg-slate-100 py-5 flex flex-col cursor-pointer gap-6 items-center justify-evenly md:overflow-y-scroll lg:h-screen lg:overflow-hidden'>
      {/* Header */}
